    ...
    struct WebService {
        ...
        struct Response {
            ...
            struct CommonErrorMessage {
                static let cancelled = "Request explicitly cancelled"
                static let invalidToken = "Invalid Token"
                static let unauthorized = "Unauthorized"
                static let networkUnavailable = "Please check your network connection"
                static let networkUnavailable2 = "The Internet connection appears to be offline."
            }
        }
        ...
        struct HttpHeader {
            ...
            struct Value {
                ...
                static let version = AppConstant.appVersionNumber + "." + AppConstant.appBuildNumber
            }
        }
